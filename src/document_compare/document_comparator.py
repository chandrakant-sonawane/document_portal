...
class DocumentComparatorLLM:
    def __init__(self):
        ...
        self.prompt = PROPMT_REGISTRY.get("document_comparator")
    ...
    def compare_documents(self):
        ...
        try:
            ...
            self.log.error(f"Error occurred while comparing documents:", error=str(e))
    ...
    def _format_response(self):
        ...
        try:
            ...
            self.log.error(f"Error occurred while formatting response:", error=str(e))
